...
public class GistApiTest {
    ...
    public void createGist() throws IOException {
        ...
        //create gist
        Response<Gist> response = api.creatGist(GistInterface.TOKEN, fileGist).execute();
        ...
        Response<Gist> responseList = api.listGist(GistInterface.TOKEN,id).execute();
    ...
    public void deleteGistTest() throws IOException {
        ...
        Response<Gist> objcreated = api.creatGist(GistInterface.TOKEN,filee).execute();
        ...
        Response<ResponseBody> objdel = api.deleteGist(GistInterface.TOKEN,idcreated).execute();

        //Confirm status code it was the expected
        Assert.assertEquals("204 No Content",objdel.headers().get("Status"));


        Response<Gist> responseList = api.listGist(GistInterface.TOKEN,idcreated).execute();
        ...
        List<Gist> mygistsafterdel = api.listUserGists(GistInterface.TOKEN).execute().body();
    ...
    public void checkFieldsGists() throws IOException {
        ...
        //Get User Gists
        Response<List<Gist>> objcreated = api.listUserGists(GistInterface.TOKEN).execute();
